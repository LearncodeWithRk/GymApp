    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-y-12 gap-x-8 xl:gap-x-12">
            <div className="col-span-2 md:col-span-4 xl:pr-8">
                <Image className="w-auto h-9" src="https://res.cloudinary.com/dysxcljt2/image/upload/v1693563709/gym%20template/logo_k9ber8.png" alt="" width={1920} height={1920} />
                ...
                <a href="#" title="" className="inline-flex items-center justify-center px-6 py-4 font-semibold text-white transition-all duration-200 bg-red-800 rounded-md hover:bg-red-500 focus:bg-red-800 mt-7">
            ...
            <ul className="flex items-center mt-5 space-x-3 md:order-3 sm:mt-0">
                <li>
                    <a
                        href="#"
                        title=""
                        className="flex items-center justify-center text-gray-800 transition-all duration-200 bg-transparent border border-gray-300 rounded-full w-7 h-7 focus:bg-red-800 hover:text-white focus:text-white hover:bg-red-500 hover:border-red-500 focus:border-red-800"
                    >
