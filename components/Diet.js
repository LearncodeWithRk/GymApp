  ...
  return (
    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="max-w-md mx-auto text-center">
            ...
            <p className="mt-4 text-base font-normal leading-7 text-gray-600">Best Diet Plans for Your Overall Health</p>
        </div>

        <div className="grid grid-cols-2 gap-6 mt-10 lg:mt-16 lg:gap-4 lg:grid-cols-4">
            <div className="relative group">
                <div className="overflow-hidden aspect-w-1 aspect-h-1">
                    <Image className="object-cover w-full h-full transition-all duration-300 group-hover:scale-125" src="https://res.cloudinary.com/dysxcljt2/image/upload/v1693397180/gym%20template/product-1_mgu0h2.png" alt="" width={1920} height={1920} />
                </div>
            ...
            <div className="relative group">
                <div className="overflow-hidden aspect-w-1 aspect-h-1">
                    <Image className="object-cover w-full h-full transition-all duration-300 group-hover:scale-125" src="https://res.cloudinary.com/dysxcljt2/image/upload/v1693397180/gym%20template/product-2_agt32x.png" alt="" width={1920} height={1920} />
                </div>
                <div className="flex items-start justify-between mt-4 space-x-4">
                    <div>
                        <h3 className="text-xs font-bold text-gray-900 sm:text-sm md:text-base">
            ...
            <div className="relative group">
                <div className="overflow-hidden aspect-w-1 aspect-h-1">
                    <Image className="object-cover w-full h-full transition-all duration-300 group-hover:scale-125" src="https://res.cloudinary.com/dysxcljt2/image/upload/v1693397180/gym%20template/product-3_feqtdq.png" alt="" width={1920} height={1920} />
                </div>
                <div className="absolute left-3 top-3">
            ...
            <div className="relative group">
                <div className="overflow-hidden aspect-w-1 aspect-h-1">
                    <Image className="object-cover w-full h-full transition-all duration-300 group-hover:scale-125" src="https://res.cloudinary.com/dysxcljt2/image/upload/v1693397180/gym%20template/product-4_fo1ife.png" alt="" width={1920} height={1920} />
                </div>
                <div className="flex items-start justify-between mt-4 space-x-4">
                    <div>
                        <h3 className="text-xs font-bold text-gray-900 sm:text-sm md:text-base">
